    ...
    <div className="builder-surface space-y-6">
      ...
      {currentStep === 0 ? (
        <QuestionCard
          ...
          description="Start with names and three quick choices. Then we will ask for the memories that make the board feel personal."
        >
          <QuizExpectationPanel
            templateName="Milestone Trail"
            summary="We will ask for story moments, visual direction, and delivery."
            checkpoints={[
              "Pick 6+ memories",
              "Choose the mood",
